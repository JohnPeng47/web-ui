...
from src.agent.http_history import HTTPHistory, BAN_LIST

from .custom_views import CustomAgentOutput, CustomAgentState
...
class CustomAgent(Agent):
    ...
    async def run(self, max_steps: int = 100, page_max_steps: int = 10) -> AgentHistoryList:
