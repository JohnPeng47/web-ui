...
from old_browser_use.agent.prompts import SystemPrompt, AgentMessagePrompt
from old_browser_use.agent.service import Agent
from old_browser_use.agent.views import (
    ActionResult,
    AgentHistoryList,
    AgentOutput,
    AgentState,
...
from old_browser_use.agent.gif import create_history_gif
from old_browser_use.browser.browser import Browser
from old_browser_use.browser.context import BrowserContext
from old_browser_use.controller.service import Controller
from old_browser_use.telemetry.views import (
    AgentEndTelemetryEvent,
    AgentStepTelemetryEvent,
)
from old_browser_use.utils import time_execution_async
...
agent_log, full_log = getLogger(__name__), getLogger(__name__)
    ...
    async def step(self, step_info: CustomAgentStepInfo) -> None:
        ...
        try:    
            ...
            try:
                ...
                agent_log.error(f"Probably should stop executing: {e}")
                await self.shutdown(reason=f"Agent task was completed??")
