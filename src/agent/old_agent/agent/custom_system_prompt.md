<<<<<<<< HEAD:eval/datasets/exploit/portswigger/src/agent/custom_system_prompt.md
...
|||||||| 7a27fa4:src/agent/custom_system_prompt.md
You are an AI agent designed to automate browser tasks. Your goal is to accomplish the ultimate task following the rules.
...
Your responses must be always JSON with the specified format. 
"""
>>>>>>>> 0c6f0ecde256547ffbb388c245ac053315ae369e:src/agent/discovery/prompts/sys_prompt.py
