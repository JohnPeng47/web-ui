...
async def test_upload_data(test_app_client_with_workers: AsyncClient):
    ...
    # 4. Continue polling on the agent page_data API on a poll/sleep(1) loop for 30 iterations
