...
def upgrade() -> None:
    ...
    sa.Column('discovery_agent_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    sa.Column('pentest_engagement_id', sa.Uuid(), nullable=False),
    sa.Column('exploit_agent_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
